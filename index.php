        ...
        <div id="services-page" class="page">
            <section class="services">
                ...
                <div class="services-grid">
                    ...
                    <div class="service-card">
                        <div class="service-img"><img src="images/brake.jpg" alt="Brake Repair"></div>
                    ...
                    <div class="service-card">
                        <div class="service-img"><img src="images/oil.jpg" alt="Oil Change"></div>
                    ...
                    <div class="service-card">
                        <div class="service-img"><img src="images/images.jpg" alt="Tire Replacement"></div>
                    ...
                    <div class="service-card">
                        <div class="service-img"><img src="images/battery.jpg" alt="Battery Service"></div>
...
function showPage(pageId) {
    ...
    const activeLink = document.querySelector(`.nav-menu a[onclick*="${pageId}"]`);
